...
/// <summary>
/// EF Core configuration for Fund Goal totals history.
/// </summary>
internal sealed class FundGoalTotalsHistoryConfiguration : IEntityTypeConfiguration<FundGoalTotalsHistory>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<FundGoalTotalsHistory> builder)
    {
        builder.HasKey(history => history.Id);
        builder.Property(history => history.Id)
            .HasConversion(id => id.Value, value => new FundGoalTotalsHistoryId(value));

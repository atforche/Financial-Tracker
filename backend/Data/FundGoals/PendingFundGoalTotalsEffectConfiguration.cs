...
/// <summary>
/// EF Core configuration for <see cref="PendingFundGoalTotalsEffect"/>.
/// </summary>
internal sealed class PendingFundGoalTotalsEffectConfiguration : IEntityTypeConfiguration<PendingFundGoalTotalsEffect>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<PendingFundGoalTotalsEffect> builder)
    {
        builder.HasKey(effect => effect.Id);
        builder.Property(effect => effect.Id).HasConversion(id => id.Value, value => new PendingFundGoalTotalsEffectId(value));

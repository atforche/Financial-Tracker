...
public sealed class LocationRepository(DatabaseContext databaseContext) : ILocationRepository
{
    ...
    public bool IsReferenced(LocationId locationId) =>
        ...
        || databaseContext.Transactions.OfType<RefundTransaction>().Any(transaction => transaction.Sources.Any(source => source.Location != null && source.Location.Id == locationId))

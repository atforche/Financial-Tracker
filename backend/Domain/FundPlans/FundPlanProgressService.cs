...
/// <summary>
/// Service for calculating Fund Plan progress from financial facts.
/// </summary>
public static class FundPlanProgressService
{
    /// <summary>
    /// Calculates progress for a Fund Plan in an Accounting Period.
    /// </summary>
    public static FundPlanProgress Calculate(

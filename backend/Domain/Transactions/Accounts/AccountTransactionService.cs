        ...
        transactionRepository)
{
    ...
    /// </summary>
    public bool TryUnpost(AccountTransaction transaction, AccountId? accountBeingDeleted, out IEnumerable<Exception> exceptions)
    {
    ...
    /// </summary>
    protected bool ValidateUnposting(AccountTransaction transaction, AccountId? accountBeingDeleted, out IEnumerable<Exception> exceptions)
    {

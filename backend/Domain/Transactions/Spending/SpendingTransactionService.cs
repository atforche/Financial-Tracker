        ...
        transactionRepository)
{
    ...
    /// </summary>
    public bool TryUnpost(SpendingTransaction transaction, AccountId? accountBeingDeleted, out IEnumerable<Exception> exceptions)
    {
    ...
    /// </summary>
    protected bool ValidateUnposting(SpendingTransaction transaction, AccountId? accountBeingDeleted, out IEnumerable<Exception> exceptions)
    {

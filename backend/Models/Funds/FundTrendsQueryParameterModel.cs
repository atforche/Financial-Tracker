...
/// <summary>
/// Model representing the query parameters for the Fund trends endpoint.
/// </summary>
public class FundTrendsQueryParameterModel
{
    /// <summary>
    ...
    /// </summary>
    public FundTrendsSortOrderModel? Sort { get; init; }

    /// <summary>
    /// Optional sort to apply to the matching balance events.
    /// </summary>
    public FundTrendsBalanceEventSortOrderModel? BalanceEventSort { get; init; }

...
/// <summary>
/// Model representing the collection of Funds within a specified accounting period range.
/// </summary>
public class FundsInAccountingPeriodRangeModel
{
    /// <summary>
    /// Matching Funds with their balances for the requested accounting period range.
    /// </summary>
    ...
    /// </summary>
    public required IReadOnlyCollection<FundBalanceSummaryByPeriodModel> AccountingPeriods { get; init; }
}
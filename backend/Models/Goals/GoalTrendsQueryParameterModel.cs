...
/// <summary>
/// Model representing the query parameters for the Goal trends endpoint.
/// </summary>
public class GoalTrendsQueryParameterModel
{
    /// <summary>
    ...
    /// <summary>
    /// Optional Assignment Goal Type filters to apply to the trends.
    /// </summary>
    public IReadOnlyCollection<AssignmentGoalTypeModel>? AssignmentGoalType { get; init; }

    /// <summary>
    /// Optional Spending Goal Type filters to apply to the trends.
    /// </summary>
    ...
    /// </summary>
    public GoalTrendsBalanceEventSortOrderModel? AssignmentBalanceEventSort { get; init; }

    /// <summary>
    /// Optional sort to apply to the matching Spending Goal balance events.
    /// </summary>
    public GoalTrendsBalanceEventSortOrderModel? SpendingBalanceEventSort { get; init; }

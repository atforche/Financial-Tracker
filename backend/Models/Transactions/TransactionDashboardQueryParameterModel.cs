...
/// <summary>
/// Model representing the query parameters for the Transaction dashboard endpoint.
/// </summary>
public class TransactionDashboardQueryParameterModel
{
    /// <summary>
    ...
    /// <summary>
    /// Optional Transaction Type filters to apply to the dashboard.
    /// </summary>

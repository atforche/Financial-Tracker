...
/// <summary>
/// Mapper class that handles mapping Fund Goal types to Fund Goal type models
/// </summary>
internal sealed class FundGoalTypeMapper
{
    /// <summary>
    /// Maps the provided Fund Goal type to a Fund Goal type model
    /// </summary>
    ...
    /// <summary>
    /// Attempts to map the provided Fund Goal type model to a Fund Goal type
    /// </summary>

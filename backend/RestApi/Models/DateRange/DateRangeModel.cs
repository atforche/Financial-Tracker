...
namespace RestApi.Models.DateRange;
...
public class DateRangeModel
{
    ...
    public Domain.ValueObjects.DateRange GetAsDateRange() => new Domain.ValueObjects.DateRange(StartDate, EndDate, StartDateType, EndDateType);
}
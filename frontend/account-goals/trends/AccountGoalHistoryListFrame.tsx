...
const sortParamName = "goalHistorySort";
const pageParamName = "goalHistoryPage";
...
const AccountGoalHistoryListFrame = function ({
  points,
}: {
...
export default AccountGoalHistoryListFrame;

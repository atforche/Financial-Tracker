...
interface AccountGoalEndingBalanceRangeProps {
  readonly endingBalance: AccountGoalProgress["endingBalance"];
}

/**
 * Shows the current ending balance against its configured bounds on one scale.
 */
const AccountGoalEndingBalanceRange = function ({
  endingBalance,
}: AccountGoalEndingBalanceRangeProps): JSX.Element {
  const current = endingBalance.currentBalance;
      ...
      : endingBalance.status === AccountGoalEndingBalanceStatus.AboveMaximum
        ...
        : isExactTarget
          ...
          : !hasMaximum
            ...
            : "Within target range";
  const markerColor =
    endingBalance.status === AccountGoalEndingBalanceStatus.WithinRange
      ? "success.main"
      : "error.main";
...
export default AccountGoalEndingBalanceRange;

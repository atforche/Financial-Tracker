 ...
 */
const createAccountingPeriod = function (
  redirectUrl: string,
): ( _: ActionState, request: CreateAccountingPeriodRequest) => Promise<ActionState> {
  return async function (_: ActionState, request: CreateAccountingPeriodRequest): Promise<ActionState> {

...
interface AccountingPeriodDashboardAccountingPeriodFilterProps {
...
/**
 * Renders a single accounting period selector used in the accounting period dashboard.
 */
const AccountingPeriodDashboardAccountingPeriodFilter = function ({
  accountingPeriods,
  label,
  value,
  onChange,
  disabled = false,
}: AccountingPeriodDashboardAccountingPeriodFilterProps): JSX.Element {
...
export default AccountingPeriodDashboardAccountingPeriodFilter;

...
import type { AccountDashboard } from "@/accounts/types";
import type { JSX } from "react";
import SummaryCard from "@/framework/view/SummaryCard";
import formatCurrency from "@/framework/formatCurrency";

interface AccountDashboardIncomeSpendingCardProps {
  readonly dashboard: AccountDashboard;
}

/**
 * Component that displays total income and spending for the Accounts dashboard.
 */
const AccountDashboardIncomeSpendingCard = function ({
  dashboard,
}: AccountDashboardIncomeSpendingCardProps): JSX.Element {
...
export default AccountDashboardIncomeSpendingCard;

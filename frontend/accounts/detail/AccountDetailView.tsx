...
import TransactionListFrame from "@/accounts/detail/AccountTransactionListFrame";
...
/**
 * Parameters for the AccountDetailView component.
 */
interface AccountDetailViewParams {
  id: string;
}

/**
 * Search parameters for the AccountDetailView component.
 */
interface AccountDetailViewSearchParams {
  search?: string;
...
/**
 * Props for the AccountDetailView component.
 */
interface AccountDetailViewProps {
  readonly params: Promise<AccountDetailViewParams>;
  readonly searchParams: Promise<AccountDetailViewSearchParams>;
}
 ...
 */
const AccountDetailView = async function ({
  params,
  searchParams,
}: AccountDetailViewProps): Promise<JSX.Element> {
  ...
  return (
    <Stack spacing={2}>
      ...
      <Stack spacing={2} style={{ maxWidth: 1000 }}>
        ...
        <SearchBar
          paramName={nameof<AccountDetailViewSearchParams>("search")}
        />
...
export type { AccountDetailViewParams, AccountDetailViewSearchParams };

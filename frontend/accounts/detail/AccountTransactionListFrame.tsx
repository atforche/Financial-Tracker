...
import type { AccountDetailViewSearchParams } from "@/accounts/detail/AccountDetailView";
...
const AccountTransactionListFrame = function ({
  ...
  const sortSearchParamName = nameof<AccountDetailViewSearchParams>("sort");
  ...
  return (
    <ListFrame<Transaction>
      ...
      pageSearchParamName={nameof<AccountDetailViewSearchParams>("page")}
    />
  );
};

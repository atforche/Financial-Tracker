...
interface AccountTrendsAccountingPeriodFilterProps {
...
/**
 * Renders a single accounting period selector used in the account trends.
 */
const AccountTrendsAccountingPeriodFilter = function ({
  accountingPeriods,
  label,
  value,
  onChange,
  disabled = false,
}: AccountTrendsAccountingPeriodFilterProps): JSX.Element {
...
export default AccountTrendsAccountingPeriodFilter;

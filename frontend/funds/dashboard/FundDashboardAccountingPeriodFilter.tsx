...
interface FundDashboardAccountingPeriodFilterProps {
...
/**
 * Renders a single accounting period selector used in the fund dashboard.
 */
const FundDashboardAccountingPeriodFilter = function ({
  accountingPeriods,
  label,
  value,
  onChange,
  disabled = false,
}: FundDashboardAccountingPeriodFilterProps): JSX.Element {
...
export default FundDashboardAccountingPeriodFilter;

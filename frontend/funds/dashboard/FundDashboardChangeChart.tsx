...
type FundDashboardChangeChartMode = "AccountingPeriod" | "Date";

interface FundDashboardChangeChartProps {
  readonly mode: FundDashboardChangeChartMode;
...
const buildChartPoints = function (
  mode: FundDashboardChangeChartMode,
...
/**
 * Renders balance changes for the fund dashboard.
 */
const FundDashboardChangeChart = function ({
  mode,
  accountingPeriods,
  dates,
}: FundDashboardChangeChartProps): JSX.Element {
...
export default FundDashboardChangeChart;

...
import type {
  FundDashboardDateSummary,
  FundDashboardPeriodSummary,
} from "@/funds/types";
import type { JSX } from "react";
import dayjs from "dayjs";
import formatCurrency from "@/framework/formatCurrency";

type FundDashboardTrendChartMode = "AccountingPeriod" | "Date";

/**
 * Props for the FundDashboardTrendChart component.
 */
interface FundDashboardTrendChartProps {
  readonly mode: FundDashboardTrendChartMode;
  readonly accountingPeriods: readonly FundDashboardPeriodSummary[] | null;
  readonly dates: readonly FundDashboardDateSummary[] | null;
}
...
const buildDateChartPoints = function (
  dates: readonly FundDashboardDateSummary[],
): ChartPoint[] {
...
const buildAccountingPeriodChartPoints = function (
  accountingPeriods: readonly FundDashboardPeriodSummary[],
): ChartPoint[] {
...
const buildChartPoints = function ({
  ...
  accountingPeriods,
  dates,
}: FundDashboardTrendChartProps): ChartPoint[] {
  if (mode === "Date") {
...
/**
 * Renders the balance trend for the fund dashboard.
 */
const FundDashboardTrendChart = function ({
  mode,
  accountingPeriods,
  dates,
}: FundDashboardTrendChartProps): JSX.Element {
...
export default FundDashboardTrendChart;

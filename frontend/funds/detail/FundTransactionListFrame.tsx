...
import type { FundDetailViewSearchParams } from "@/funds/detail/FundDetailView";
...
const FundTransactionListFrame = function ({
  ...
  const sortSearchParamName = nameof<FundDetailViewSearchParams>("sort");
  ...
  return (
    <ListFrame<Transaction>
      ...
      pageSearchParamName={nameof<FundDetailViewSearchParams>("page")}
    />
  );
};

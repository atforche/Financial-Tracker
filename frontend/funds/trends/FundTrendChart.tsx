...
type FundTrendChartMode = "AccountingPeriod" | "Date";

/**
 * Props for the FundTrendChart component.
 */
interface FundTrendChartProps {
  readonly mode: FundTrendChartMode;
...
const buildChartPoints = function ({
  ...
  accountingPeriods,
  dates,
}: FundTrendChartProps): ChartPoint[] {
  if (mode === "Date") {
...
/**
 * Renders the balance trend for the fund trends.
 */
const FundTrendChart = function ({
  mode,
  accountingPeriods,
  dates,
}: FundTrendChartProps): JSX.Element {

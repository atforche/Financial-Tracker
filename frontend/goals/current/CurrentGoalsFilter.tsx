...
interface CurrentGoalsFilterProps {
  readonly availableFundNames: readonly string[];
  readonly disabled?: boolean;
}

/**
 * Filter for the current goals page.
 */
const CurrentGoalsFilter = function ({
  availableFundNames,
  disabled = false,
}: CurrentGoalsFilterProps): JSX.Element {
  ...
  const hasActiveView = shouldPersistFundNames(currentFundNames);
...
export default CurrentGoalsFilter;

...
/**
 * Parameters for the transaction view component.
 */
...
/**
 * Search parameters for the transaction view component.
 */
interface TransactionViewSearchParams {
...
/**
 * Props for the TransactionView component.
 */
interface TransactionViewProps {
  readonly params: Promise<TransactionViewParams>;
  readonly searchParams: Promise<TransactionViewSearchParams>;
}

/**
 * Component that displays the transaction detail view.
 */
const TransactionView = async function ({
  params,
  searchParams,
}: TransactionViewProps): Promise<JSX.Element> {
...
export type { TransactionViewParams, TransactionViewSearchParams };

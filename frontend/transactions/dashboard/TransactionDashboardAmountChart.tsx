...
import type {
  TransactionDashboardDateSummary,
  TransactionDashboardPeriodSummary,
} from "@/transactions/types";
import type { JSX } from "react";
import dayjs from "dayjs";
import formatCurrency from "@/framework/formatCurrency";

type TransactionDashboardAmountChartMode = "AccountingPeriod" | "Date";

interface TransactionDashboardAmountChartProps {
  readonly mode: TransactionDashboardAmountChartMode;
  readonly accountingPeriods:
    | readonly TransactionDashboardPeriodSummary[]
    | null;
  readonly dates: readonly TransactionDashboardDateSummary[] | null;
}
...
const buildChartPoints = function (
  mode: TransactionDashboardAmountChartMode,
  accountingPeriods: readonly TransactionDashboardPeriodSummary[],
  dates: readonly TransactionDashboardDateSummary[],
): ChartPoint[] {
...
/**
 * Renders transaction amounts for the Transactions dashboard.
 */
const TransactionDashboardAmountChart = function ({
  mode,
  accountingPeriods,
  dates,
}: TransactionDashboardAmountChartProps): JSX.Element {
      ...
      >
        <Stack spacing={1}>
          ...
          <Typography variant="body2" color="text.secondary">
            No transaction amounts are available for the selected dashboard
            range.
          </Typography>
        </Stack>
      </Paper>
...
export default TransactionDashboardAmountChart;

...
type TransactionDashboardCountChartMode = "AccountingPeriod" | "Date";

interface TransactionDashboardCountChartProps {
  readonly mode: TransactionDashboardCountChartMode;
...
const buildChartPoints = function (
  mode: TransactionDashboardCountChartMode,
...
/**
 * Renders transaction counts for the Transactions dashboard.
 */
const TransactionDashboardCountChart = function ({
  mode,
  accountingPeriods,
  dates,
}: TransactionDashboardCountChartProps): JSX.Element {
      ...
      >
        <Stack spacing={1}>
          ...
          <Typography variant="body2" color="text.secondary">
            No transaction counts are available for the selected dashboard
            range.
          </Typography>
        </Stack>
      </Paper>
...
export default TransactionDashboardCountChart;

...
/**
 * Dashboard filter mode values used in the Transactions view URL.
 */
type TransactionDashboardFilterMode = "accounting-period" | "date";

/**
 * Props for the TransactionDashboardFilter component.
 */
interface TransactionDashboardFilterProps {
...
/**
 * Renders the dashboard filter card for the Transactions view.
 */
const TransactionDashboardFilter = function ({
  accountingPeriods,
  ...
  defaultEndDate,
  disabled = false,
}: TransactionDashboardFilterProps): JSX.Element {
  ...
  const currentMode: TransactionDashboardFilterMode =
  ...
  const handleModeChange = function (
    ...
    nextMode: TransactionDashboardFilterMode | null,
  ): void {
    if (nextMode === null) {
      return;
    }
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        <Stack spacing={0.5}>
          <Typography variant="h5">Transaction Dashboard</Typography>
        </Stack>
        <Stack
          direction="row"
          spacing={1.5}
...
export default TransactionDashboardFilter;

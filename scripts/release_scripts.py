...
def main() -> None:
    ...
    commands = CommandCollection("Validates release inputs used by deployment workflows")
...
class ValidateReleaseRun(Command):
    ...
    def __init__(self) -> None:
        ...
        super().__init__("validate-run", "Validates a successful main release workflow run")
        self.steps.append(Step("Validate Release Workflow Run", "Release workflow run validated", self.validate_run))
    ...
    def validate_run(self) -> None:
        ...
        mismatches = [
            name for name, expected in expected_values.items()
...
class ValidateReleaseArtifact(Command):
    ...
    def __init__(self) -> None:
        ...
        self.steps.append(Step("Validate Release Artifact", "Release artifact validated", self.validate_artifact))
    ...
    def validate_artifact(self) -> None:
        ...
        if release_manifest.commit != self.commit:
            raise RuntimeError("Release artifact commit does not match the requested commit")
